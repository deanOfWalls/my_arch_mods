...
install_dependencies() {
    ...
    sudo pacman -Sy scrot xclip
    echo "Dependencies installed."
}

# Function to generate the screenshot script
generate_screenshot_script() {
    cat <<'EOF' > deans-screenshot-util.sh
#!/bin/bash
...
EOF
    ...
    chmod +x deans-screenshot-util.sh
    echo "Screenshot script 'deans-screenshot-util.sh' generated and made executable."
}
